...
public abstract class DocIdSetIterator {
   ...
   * #intoBitSet}.
   *
   * <p>The default implementation loads into {@code scratch} via {@link #intoBitSet} then ANDs.
   * Implementations that know their block-level density (e.g. posting list decoders with UNARY
   * blocks) should override this to skip fully-dense blocks at zero cost.
   *
   * @lucene.internal
   */
